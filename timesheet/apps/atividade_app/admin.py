...
class RegistroAtividadeAdmin(admin.ModelAdmin):
    list_display = ('id', 'RAM_colaborador', 'RAM_cliente', 'RAM_servico', 'RAM_atividade', 'hora_formatada', 'RAM_dataFinal', 'RAM_duracao')
    list_display_links = ('id', 'RAM_colaborador', 'RAM_cliente', 'RAM_servico')
    fields = ['RAM_cliente', 'RAM_servico', 'RAM_atividade']
    list_filter = ('RAM_colaborador', 'RAM_cliente', 'RAM_servico', 'RAM_atividade', 'RAM_dataInicial')
